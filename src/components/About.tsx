        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto items-start">
          ...
          <div className="space-y-8">
            ...
            <motion.div
              ...
              className="relative bg-gradient-to-br from-background/80 to-background/60 border border-border/50 rounded-3xl p-8 shadow-xl backdrop-blur-sm overflow-hidden"
            >
