...
import { Code, Database, GitGraph, Brain, FileCode, Cpu, BookOpen } from "lucide-react";
...
export const TechStackSection = () => {
  ...
  return (
    <div className="space-y-12">
      ...
      >
        <h3 className="text-2xl font-bold mb-4 text-foreground">Documentation & Open Source Repository</h3>
        <p className="text-muted-foreground mb-6">
          Full source code, notebooks, dataset documentation, and the PFAS poster summary are available for review.
        </p>
        <div className="flex flex-wrap justify-center gap-3">
          <a
            href="/Rapport_PFAS_Knowledge_Graph.pdf"
            download
          ...
          >
            ...
            Download PFAS Report
          </a>
          <a
            href="/pfas_poster_v7_integrated.html"
            target="_blank"
